...
class RectorProcessor {
  ...
  public function runRector(Extension $extension) {
    ...
    $config = file_get_contents($module_path . '/rector.yml');
    // Even though Rector would resolve %vendor_dir% by itself, that would be
    ...
    $config_path = $temporary_directory . '/upgrade_rector.yml';
